import { addSkip } from '../src/methods/skip';
...
describe('Array.prototype.skip', () => {
  test('method is added to Array prototype', () => {
    expect(typeof Array.prototype.skip).toBe('function');
  });
